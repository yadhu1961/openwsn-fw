...
/**
\brief Trigger this module to get neighbor information, to application level.

neighbors_getNeighborInfo function is used by the application layer to get neighbor information
